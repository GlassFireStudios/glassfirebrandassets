/* @ds-bundle: {"format":3,"namespace":"GlassFireDesignSystem_019e1f","components":[{"name":"LogoGrid","sourcePath":"components/LogoGrid.jsx"}],"sourceHashes":{"components/LogoGrid.jsx":"e9c44e9f6632","slides/deck-stage.js":"5e65f78ba7d6","slides/image-slot.js":"5ade9426e255","ui_kits/website/App.jsx":"757f20de0f51","ui_kits/website/CaseStudies.jsx":"5ac550b8c59e","ui_kits/website/Contact.jsx":"6426b62d4491","ui_kits/website/Header.jsx":"83c2dfb54090","ui_kits/website/Hero.jsx":"382807b10e8e","ui_kits/website/Services.jsx":"293350947bba","ui_kits/website/Team.jsx":"5453ceed44c5","ui_kits/website/image-slot.js":"5ade9426e255"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.GlassFireDesignSystem_019e1f = window.GlassFireDesignSystem_019e1f || {});
...
const DEFAULT_CLIENTS = [{
  ...
  name: "Enhanced Games",
  file: "Enhanced Games.png"
}, {
  name: "Google",
  file: "Google.png"
}, {
  name: "High Point University",
  file: "High Point University.png"
}, {
  name: "Intuit",
  file: "Intuit.png"
}, {
  ...
  file: "Ronald McDonald House.png"
}, {
  name: "Samsung",
  file: "Samsung.png"
}, {
  name: "University of Kentucky",
  file: "University of Kentucky.png"
}, {
  name: "Volvo",
  file: "Volvo.png"
}, {
  name: "YouTube Music",
  file: "YouTube Music.png"
}];
const BG_PRESETS = {
  black: "#000000",
  ink: "#0A0A0C",
...
function LogoGrid({
  ...
  title = "TRUSTED BY",
  variant = "white",
  // "white" (logos as-is) | "black" (inverted for light bg)
  background = "black",
  // preset key or any CSS color
  columns = "auto",
  // number | "auto"
  gap = 40,
  rowHeight = 56,
  ...
  stagger = false,
  muted = 0.7,
  // resting logo opacity (0–1)
  align = "center",
  // "center" | "left"
  titleColor = null,
  accent = "fire",
  // "fire" | "glass" | "none" — rule under the title
  watermarkSrc = null,
  // GlassFire mark, bottom-right; null = off
  targetAspect = 2.4,
  style = {}
} = {}) {
  // Resolve roster -------------------------------------------------------
  let roster = clients ? clients : DEFAULT_CLIENTS.map(c => ({
    name: c.name,
    src: `${basePath}/${c.file}`
  }));
  if (names && names.length) {
    const want = names.map(s => s.toLowerCase());
    roster = roster.filter(c => want.includes(c.name.toLowerCase())).sort((a, b) => want.indexOf(a.name.toLowerCase()) - want.indexOf(b.name.toLowerCase()));
  }
  const n = roster.length;
  const bg = BG_PRESETS[background] || background;
  const isLight = bg === "#FFFFFF" || bg === "#ffffff" || bg === "white";
  const cols = columns === "auto" ? autoColumns(n, cellWidth, rowHeight, gap, targetAspect) : Math.max(1, columns);
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, title), accentColor ? /*#__PURE__*/React.createElement("div", {
    style: {
      width: 44,
      height: 3,
  ...
  }, roster.map((c, i) => /*#__PURE__*/React.createElement("div", {
    key: c.name + i,
    title: c.name,
    style: {
      height: rowHeight,
    ...
    onMouseLeave: e => {
      e.currentTarget.style.opacity = String(muted);
    }
  })))), watermarkSrc ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/LogoGrid.jsx", error: String((e && e.message) || e) }); }
...
function App() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Header, {
    ...
    onCtaClick: open
  }), /*#__PURE__*/React.createElement(TrustedBy, null), /*#__PURE__*/React.createElement(ServicesGrid, null), /*#__PURE__*/React.createElement(Manifesto, null), /*#__PURE__*/React.createElement(CaseStudies, null), /*#__PURE__*/React.createElement(TeamGrid, null), /*#__PURE__*/React.createElement(CtaRibbon, {
    onCtaClick: open
...
if (_gfRoot) ReactDOM.createRoot(_gfRoot).render(/*#__PURE__*/React.createElement(App, null));
...
function CaseStudyCard({
  ...
  return /*#__PURE__*/React.createElement("article", {
    ...
    id: `case-${study.id}`,
    placeholder: study.placeholder || study.client + " hero still",
    style: {
      width: '100%',
      height: '100%'
    }
    ...
    style: {
      ...
      textTransform: 'uppercase',
      background: 'rgba(238,39,80,0.18)',
      color: '#EE2750',
  ...
  }, study.client), /*#__PURE__*/React.createElement("div", {
    className: "eyebrow muted",
    style: {
      fontSize: 10,
      letterSpacing: '0.18em'
    }
  }, study.tags.join(' · ')), large && /*#__PURE__*/React.createElement("p", {
    style: {
      margin: '6px 0 0',
      color: '#B8B8BE',
      fontSize: 15,
  ...
  }, study.summary), /*#__PURE__*/React.createElement("a", {
    style: {
      marginTop: 'auto',
      display: 'inline-flex',
      alignItems: 'center',
  ...
  }, "Read case", /*#__PURE__*/React.createElement("svg", {
    width: "12",
    height: "12",
    viewBox: "0 0 24 24",
    fill: "none",
...
function CaseStudies() {
  ...
  }, "On message,", /*#__PURE__*/React.createElement("br", null), "on budget,", /*#__PURE__*/React.createElement("br", null), "built to perform.")), /*#__PURE__*/React.createElement("a", {
    className: "gf-btn gf-btn-ghost",
    href: "#work-all"
  }, "All Case Studies", /*#__PURE__*/React.createElement("svg", {
    width: "14",
    height: "14",
    viewBox: "0 0 24 24",
    fill: "none",
...
function CtaRibbon({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Tell us about your project \u2014 a commercial, a broadcast, a brand film, or something we haven't done yet."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 32,
      display: 'flex',
      justifyContent: 'center',
    ...
    className: "gf-btn gf-btn-fire",
    onClick: onCtaClick
  }, "Start a Project", /*#__PURE__*/React.createElement("svg", {
    width: "14",
    height: "14",
    viewBox: "0 0 24 24",
    fill: "none",
    ...
    className: "gf-btn gf-btn-ghost",
    href: "mailto:hello@glassfire.co"
  }, "hello@glassfire.co"))));
}
function Footer() {
  ...
  }, "Crafting visual experiences that inspire. Cinematic content, branded films, and live broadcasts.")), /*#__PURE__*/React.createElement(FooterCol, {
    title: "Studio",
    links: ['Cinematic Video', 'Live & Events', 'Post Production', 'Rentals & Stage']
  }), /*#__PURE__*/React.createElement(FooterCol, {
    title: "Company",
    links: ['Work', 'Team', 'Journal', 'Careers']
  }), /*#__PURE__*/React.createElement(FooterCol, {
    title: "Visit",
    links: ['Raleigh', 'Lexington', 'Bentonville', 'hello@glassfire.co']
  })), /*#__PURE__*/React.createElement("div", {
    className: "rule"
  }), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\xA9 ", new Date().getFullYear(), " GlassFire Productions \xB7 919.867.4547"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 18
    }
  }, ['Instagram', 'Vimeo', 'LinkedIn'].map(s => /*#__PURE__*/React.createElement("a", {
    key: s,
    style: {
      fontSize: 11,
      fontWeight: 700,
...
function ContactModal({
  ...
  }, "Tell us about it."), /*#__PURE__*/React.createElement("p", {
    style: {
      color: '#B8B8BE',
      fontSize: 14,
      lineHeight: 1.55,
  ...
  }, "Thanks for reaching out. A producer will reply within one business day."), /*#__PURE__*/React.createElement("button", {
    onClick: onClose,
    className: "gf-btn gf-btn-ghost",
    style: {
      marginTop: 24
...
function Header({
  ...
  }, ['Work', 'Services', 'Studio', 'About', 'Journal'].map(item => /*#__PURE__*/React.createElement("a", {
    key: item,
...
function Hero({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Full-Service Production"), /*#__PURE__*/React.createElement("h1", {
    style: {
      margin: 0,
      fontWeight: 800,
      textTransform: 'uppercase',
  ...
  }, "CRAFTING", /*#__PURE__*/React.createElement("br", null), "VISUAL", /*#__PURE__*/React.createElement("br", null), "EXPERIENCES", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    className: "gf-text-spark"
  }, "THAT INSPIRE")), /*#__PURE__*/React.createElement("p", {
    style: {
      marginTop: 40,
      maxWidth: 620,
      fontSize: 20,
  ...
  }, "At GlassFire, we craft cinematic content and brand storytelling that ignites emotion and drives action. From commercials to live broadcasts, we turn bold ideas into unforgettable visual experiences."), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 40,
      display: 'flex',
      gap: 14,
    ...
    d: "M12 0l2.39 7.36H22l-6.18 4.49L18.18 19 12 14.51 5.82 19l2.36-7.15L2 7.36h7.61L12 0z"
  }))))))));
}
window.Hero = Hero;
...
function ServicesGrid() {
  ...
  }, "We hold both sides", /*#__PURE__*/React.createElement("br", null), "of the craft \u2014", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    className: "gf-text-fire"
  }, "the frame"), " and ", /*#__PURE__*/React.createElement("span", {
    className: "gf-text-glass"
  }, "the flame"), "."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, s.eyebrow, " / 03"), /*#__PURE__*/React.createElement("h3", {
    style: {
      margin: 0,
      fontWeight: 800,
      textTransform: 'uppercase',
  ...
  }, s.title.map((line, i) => /*#__PURE__*/React.createElement("div", {
    key: i
...
function Manifesto() {
  ...
  }, "Clarity Meets Spark"), /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: 0,
      fontWeight: 800,
      textTransform: 'uppercase',
  ...
  }, "The technical", /*#__PURE__*/React.createElement("br", null), "and the human.")), /*#__PURE__*/React.createElement("div", {
    style: {
      color: '#E6E6E8',
      fontSize: 18,
      lineHeight: 1.6,
  ...
  }, "Our name reflects the balance at the core of our work: the clarity and precision of glass combined with the raw spark and emotion of fire."), /*#__PURE__*/React.createElement("p", null, "We bring rigorous technical expertise, the sharp focus of a lens, the polish of detail, and the composure to perform under pressure. We match that with an instinct for storytelling \u2014 bold narratives, vibrant emotion, and creative ignition forging genuine connection."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontWeight: 600,
      color: '#fff'
    }
  }, "We hold both sides of the craft: ", /*#__PURE__*/React.createElement("span", {
    className: "gf-text-glass"
  }, "the clean"), " and ", /*#__PURE__*/React.createElement("span", {
    className: "gf-text-fire"
  }, "the raw"), ", the frame and the flame."))));
}
function TeamGrid() {
  const team = [{
    name: 'Nate Glass',
    pronouns: 'he/him',
    role: 'Founder, Producer, Cinematographer'
  }, {
    name: 'Laura MacFie Glass',
    pronouns: 'she/her',
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Six humans.", /*#__PURE__*/React.createElement("br", null), "One craft."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(3, 1fr)',
      gap: 24
    ...
    id: `team-${p.name.split(' ')[0].toLowerCase()}`,
    placeholder: `${p.name} portrait`,
    style: {
      width: '100%',
      height: '100%'
    }
  ...
  }, "(", p.pronouns, ")")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 6,
      fontSize: 13,
      color: '#B8B8BE',
