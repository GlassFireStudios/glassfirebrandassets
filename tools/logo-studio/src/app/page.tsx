...
const tools = [
  ...
  { href: "/characters", hover: "hover:border-glass", title: "Characters", body: "Meet the Firefly crew the workstations are named after — portraits, bios, and the rig each one runs." },
